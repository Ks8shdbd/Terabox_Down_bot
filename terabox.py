...
def is_member(user_id):
    try:
        member_status = bot.get_chat_member('-1001884153869', user_id)
...
# Store User To DB
    ...
    inline_keyboard.row(
     telebot.types.InlineKeyboardButton("ᴊᴏɪɴ ❤️🚀", url=f"https://t.me/ary_botz"),
     telebot.types.InlineKeyboardButton("ᴅᴇᴠᴇʟᴏᴘᴇʀ ⚡️", url="tg://user?id=5079629749")
    )
